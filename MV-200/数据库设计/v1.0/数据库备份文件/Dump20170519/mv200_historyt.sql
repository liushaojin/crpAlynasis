...
CREATE TABLE `historyt` (
  ...
  `AD41` double DEFAULT NULL,
  `AD42` double DEFAULT NULL,
  `AD43` double DEFAULT NULL,
  `AD44` double DEFAULT NULL,
  `AD45` double DEFAULT NULL,
  `AD46` double DEFAULT NULL,
  `AD47` double DEFAULT NULL,
  `AD48` double DEFAULT NULL,
  `AD49` double DEFAULT NULL,
  `AD50` double DEFAULT NULL,
  ...
  `T41` datetime(6) DEFAULT NULL,
  `T42` datetime(6) DEFAULT NULL,
  `T43` datetime(6) DEFAULT NULL,
  `T44` datetime(6) DEFAULT NULL,
  `T45` datetime(6) DEFAULT NULL,
  `T46` datetime(6) DEFAULT NULL,
  `T47` datetime(6) DEFAULT NULL,
  `T48` datetime(6) DEFAULT NULL,
  `T49` datetime(6) DEFAULT NULL,
  `T50` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
