...
CREATE TABLE `projectt` (
  ...
  `isDiluent` int(11) NOT NULL DEFAULT '0',
  `unit` varchar(10) NOT NULL DEFAULT 'mg/L',
  `accuracy` int(11) NOT NULL DEFAULT '2',
  `lowLinear` double unsigned zerofill DEFAULT NULL,
  `K` double NOT NULL DEFAULT '1',
  `bloodFactor` double NOT NULL DEFAULT '1',
  `lightPos1` int(11) NOT NULL DEFAULT '3',
  `lightPos2` int(11) NOT NULL DEFAULT '10',
  `r0ID` int(10) unsigned zerofill DEFAULT '0000000000',
  `r1ID` int(10) unsigned zerofill DEFAULT '0000000000',
  `r2ID` int(10) unsigned zerofill DEFAULT '0000000000',
  `sampleVol` int(10) unsigned zerofill DEFAULT NULL,
  `r0Vol` int(10) unsigned zerofill DEFAULT NULL,
  `r1Vol` int(10) unsigned zerofill DEFAULT NULL,
  `rsVol` int(10) unsigned zerofill DEFAULT NULL,
  `r2Vol` int(10) unsigned zerofill DEFAULT NULL,
  `testMethodID` int(11) DEFAULT '1',
  `reactionDirID` int(11) DEFAULT '1',
  `calibrateID` int(11) DEFAULT '1',
  ...
  `isCalibrate2` int(11) NOT NULL DEFAULT '0',
  ...
  `ProjectTcol` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
...
INSERT INTO `projectt` VALUES (1,'crp','55555',0,'mg/L',2,NULL,1,1,3,10,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'DDD','555',0,'mg/L',2,NULL,1,1,3,10,0000000000,0000000000,0000000000,NULL,NULL,NULL,NULL,NULL,1,1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2017-05-10 13:55:16
